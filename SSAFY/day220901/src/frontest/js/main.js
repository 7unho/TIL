...
var contentLeftPollDiv = document.querySelector(".content-left-poll");
var contentLeftPollBtnDiv = document.querySelector(".content-left-poll-btn");
...
document.querySelector("#btn-makepoll").addEventListener("click", function(){
    window.open("./makepoll.html", "mkpoll", "width=420, height=300"); // url, name, size
});